...
const MyForm: React.FC = () => {
  ...
  const handleSwap = async () => {
    ...
    try {
      ...
      const swapAmount = BigNumber.from(
        Math.floor(Number(swapDetails.amount))
              ...
              <IonCol>
                <IonItem>
                  <IonSelect
                    ...
                    onIonChange={(e) =>
                      handleTokenChange(e.detail.value, false)
                    }
                  >
                    {getFilteredTokenOptions(fromToken, fromChain).map(
                      (option) => (
                        <IonSelectOption
                          key={option.value}
                          value={option.value}
              ...
              <IonCol>
                <IonItem>
                  <IonSelect
                    ...
                    value={toChain}
                    onIonChange={(e) =>
                      handleChainChange(e.detail.value, false)
                    }
                    disabled={!toToken}
                  >
